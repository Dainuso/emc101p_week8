...
let deskmaterial = new THREE.MeshBasicMaterial( {color: "#8f6558"} );
...
let leg1material = new THREE.MeshBasicMaterial( {color: "#8f6558"} );
...
let leg2material = new THREE.MeshBasicMaterial( {color: "#8f6558"} );
...
let back1material = new THREE.MeshBasicMaterial( {color: "#8f6558"} );
...
let back2material = new THREE.MeshBasicMaterial( {color: "#8f6558"} );
...
let lamp1material = new THREE.MeshBasicMaterial( {color: "#808080"
} );
...
let lamp2material = new THREE.MeshBasicMaterial( {color: "#808080"} );
...
let lamp3material = new THREE.MeshBasicMaterial( {color: "#808080"} );
...
let lamp4material = new THREE.MeshBasicMaterial( {color: "#808080"} );
...
let lamp7material = new THREE.MeshBasicMaterial( {color: "#808080"} );
...
let monitor1material = new THREE.MeshBasicMaterial( {color: "#262626"} );
...
let monitor2material = new THREE.MeshBasicMaterial( {color: "#e9e9e9"} );
...
let monitor3material = new THREE.MeshBasicMaterial( {color: "#262626"} );
...
let book1material = new THREE.MeshBasicMaterial( {color: "#087056"} );
...
let book3material = new THREE.MeshBasicMaterial( {color: "#db062f"} );
...
let book5material = new THREE.MeshBasicMaterial( {color: "#0c5fbd"} );
